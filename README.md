<!-- ████████████████████████████████████████████████████████████████████████ -->
<!-- ██                                                                    ██ -->
<!-- ██   AASIM NADAF — GITHUB PROFILE README                             ██ -->
<!-- ██   The kind of README that makes people stop scrolling.            ██ -->
<!-- ██                                                                    ██ -->
<!-- ████████████████████████████████████████████████████████████████████████ -->
...
║  ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝  ╚═╝╚═╝     ╚═╝    ╚═╝  ╚═══╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝       ║
║                                                                                         ║
║                  [ FULL STACK DEV ]     [ CO-FOUNDER @ TECHNOLEDGE ]                    ║
║                  [ MCA @ RIT ]          [ SOLO BUILDER ]                                ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
```
╭──────────────────────────────────────────────────────────────────────────────╮
│  $ ls -la tech-stack/ | sort --by=mastery                                    │
╰──────────────────────────────────────────────────────────────────────────────╯
```
...
<details open>
<summary><b>🛠️ &nbsp;Tools, DevOps & Design</b></summary>
<br/>
<div align="center">
...
```
╭──────────────────────────────────────────────────────────────────────────────╮
│  $ cat shipped.log | grep "status:LIVE OR status:BUILDING"                  │
╰──────────────────────────────────────────────────────────────────────────────╯
```
...
#### 📝 [Jotly — Real-Time Collaborative Document Editor](https://github.com/Aasim-Nadaf)
> *Google Docs, but make it mine.*

```
Status    : 🔴 ACTIVELY BUILDING
Category  : SaaS / Productivity
Scope     : Full-Stack Solo Build
```

**What makes it different:**
- ⚡ Real-time multi-user document editing with **operational transforms**
- 🖊️ Rich text editing powered by **Tiptap Editor** — headings, lists, embeds, code blocks
- 🔐 Secure auth with row-level security via **Supabase RLS**
- 📂 Document organization, sharing permissions, version history
- 🌙 Fully responsive with dark/light mode — pixel-perfect UI
...
#### 🎵 [LoopSync — Music Streaming Platform](https://github.com/Aasim-Nadaf)
> *Spotify vibes, built from scratch.*
...
**What makes it different:**
- 🎧 Full music streaming with **custom audio player** — seek, shuffle, repeat
- 📤 User music upload + **cloud storage** with Supabase buckets
- 🎼 Playlist creation, management, and social sharing
- 🔍 Search by artist, album, track with real-time filtering
- 📱 Fully responsive — desktop to mobile, perfect breakpoints
...
<!-- PROJECT 3 — CERTIFIHUB -->
<table width="100%">
<tr>
<td width="65%" valign="top">

#### 📄 [CertifiHub — Government Document Management System](https://github.com/Aasim-Nadaf)
> *Making government paperwork not terrible.*

```
Status    : ✅ SHIPPED  |  👔 FREELANCE CLIENT
Category  : GovTech / Document Processing
Scope     : Full-Stack Solo Delivery
```

**What makes it different:**
- 🏛️ End-to-end govt certificate processing with **digital token generation**
- 🔐 Secure multi-role auth — citizen, officer, admin access levels
- 📋 Document **verification workflow** with full audit trail logging
- 🖨️ Digital token system — eliminates physical queues completely
- ⚡ Built solo from client brief → design → deployment
...
#### 🏗️ [Edificee Global — Civil Engineering Corporate Website](https://github.com/Aasim-Nadaf)
> *Where craft meets code.*

```
Status    : ✅ LIVE  |  👔 FREELANCE CLIENT
Category  : Corporate / Business
Scope     : Frontend Solo Delivery
```

**What makes it different:**
- 🏛️ Sophisticated design language matching the civil engineering industry
- 📱 Pixel-perfect responsive — tested across 12+ device sizes
- 🔍 SEO-optimized with **metadata, sitemap, structured data**
- ⚡ Near-perfect Lighthouse scores — performance-first architecture
- 🎨 Custom animations, scroll-reveal, cinematic hero transitions
...
|:---:|:---|:---:|:---:|
| **🛒 ShopHub** | Full eCommerce — product catalog, cart, secure checkout, order tracking | React Native + Node.js + MongoDB | ✅ Shipped |
| **📲 ScanNPay** | Barcode scanner with real-time product lookup + integrated payment flow | React Native + REST API | ✅ Shipped |
| **🍔 QuickBite** | Food delivery platform — browse, order, real-time tracking, driver view | React Native + Firebase | ✅ Shipped |
| **💰 FinTrack** | Personal finance manager — expenses, income, visual charts, budget goals | Flutter + Firebase + Dart | ✅ Shipped |
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  2022                      2023                      2024               NOW
   ...
   │                         ▼                         ▼                  ▼
   │              ┌──────────────────┐    ┌────────────────────┐  ┌──────────────┐
   │              │ SOFTWARE DEV     │    │ CO-FOUNDER         │  │ MCA STUDENT  │
   │              │ @ MIRACLE        │    │ @ TECHNOLEDGE      │  │ @ RIT        │
   │              │ INFOTECH         │    │ UNLIMITED (MSME)   │  │              │
   │              │                  │    │                    │  │ + FREELANCE  │
   │              │ • React Native   │    │ • Client Projects  │  │ + BUILDING   │
   │              │ • Flutter        │    │ • Architecture     │  │ • JOTLY      │
   │              │ • MERN Stack     │    │ • Full Delivery    │  │ • LOOPSYNC   │
   │              │ • JWT + Auth     │    │ • Tech Decisions   │  │ • MORE...    │
   │              │ • 4+ App Builds  │    │ • Team Leadership  │  │              │
   └──────────────┴──────────────────┴────┴────────────────────┴──┴──────────────┘

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  RESULT: A developer who has shipped real products, led a company, and
          still shows up every day to learn, build, and level up.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
#### 🏢 Miracle Infotech
**Software Developer**
`Sangli, Maharashtra · 1 Year`

- 📱 Built **4+ cross-platform mobile apps** using React Native & Flutter — shipped to production
- 🛒 Developed full-stack **eCommerce platforms** with MERN Stack
- 🔐 Implemented robust auth systems — JWT, bcrypt, session management
- 🗄️ Integrated **MongoDB, MySQL, Firebase, Supabase** across different project needs
- 🔗 Built and consumed **REST APIs** connecting mobile clients to backend services
- 🚀 Delivered features end-to-end with zero hand-holding

</td>
<td width="33%" valign="top">

#### 💼 Technoledge Unlimited
**Co-Founder & Lead Dev**
`MSME Registered · Ongoing`

- 🏛️ Co-founded a **registered MSME software company** while pursuing MCA
- 🧠 Make all **tech architecture decisions** — stack, DB design, deployment strategy
- 👨‍💻 Handle **end-to-end client delivery** — requirements through deployment
- 💬 Lead **client communication** and project scoping independently
- 💰 Delivered **freelance projects** (CertifiHub, Edificee Global) with full ownership
- 🔁 Proof that student + founder + developer is not impossible

</td>
<td width="33%" valign="top">

#### 🎓 Rajarambapu Inst. of Technology
**MCA — Master of Computer Applications**
`Current · Maharashtra`

- 📚 Advanced coursework in **System Design, DBMS, Algorithms, Networks**
- 🔬 Applied academic concepts directly in **production-grade projects**
- 🏆 Building real products and running a company **simultaneously**
- 🤝 Active contributor in technical communities and developer circles
- 🎯 Graduating with actual shipped products, not just a certificate
- 💡 Proof that textbook knowledge and real-world code can coexist
...
╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║   $ ping aasim-nadaf --check-availability                                   ║
║   > HOST IS UP ✅  RESPONDING ✅  OPEN FOR WORK ✅                           ║
║                                                                              ║
║   Currently accepting:                                                       ║
║                                                                              ║
║   [✓] Full Stack Development (Web)      [✓] React Native / Flutter Mobile   ║
║   [✓] MERN Stack Projects               [✓] Next.js Applications            ║
║   [✓] Freelance Collaborations          [✓] Startup MVPs                    ║
║   [✓] Remote Roles & Contracts          [✓] Interesting Hard Problems       ║
║                                                                              ║
║   What I bring:  I don't need a team to ship. I AM the team.                ║
║   Turnaround:    Fast. Tested. Documented. Deployed.                        ║
║   Communication: Proactive, clear, no ghost mode.                           ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
...
╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║      "I don't just write code — I engineer experiences, ship products,      ║
║       and build businesses. Solo. Fast. Right the first time."              ║
║                                                                              ║
║                                                   — Aasim Nadaf             ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
...
<!-- ══════════════════════════════════════════════════════════ -->
<!-- Made with obsession, not templates. — Aasim Nadaf        -->
<!-- ══════════════════════════════════════════════════════════ -->
